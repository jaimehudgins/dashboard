      ...
      <div className="flex-shrink-0">
        {activeFocusSession ? (
          ...
          <button
            ...
            className="flex items-center gap-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-4 py-2 rounded-full shadow-md hover:shadow-lg transition-all hover:scale-105"
          >
          ...
          <button
            onClick={() => setShowPicker(true)}
            className="flex items-center gap-2 bg-white border-2 border-indigo-600 text-indigo-600 px-4 py-2 rounded-full shadow-md hover:shadow-lg transition-all hover:scale-105 hover:bg-indigo-50"
          >
            <Focus size={20} />
